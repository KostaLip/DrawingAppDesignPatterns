...
public class DlgHexagon extends JDialog {
	...
	public JTextArea txtCenterX = new JTextArea();
	public JTextArea txtCenterY = new JTextArea();
	...
	private Color hexagonInnerColor;
	 ...
	 * Create the dialog.
	 */
	public DlgHexagon(Color color, Color innerColor) {
		hexagonColor = color;
		...
		}
		{
			...
			btnColor.setBackground(hexagonColor);
			btnColor.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Color temp;
					temp = JColorChooser.showDialog(null, "Select a color", hexagonColor);
					if(temp != null) {
						hexagonColor = temp;
						btnColor.setBackground(hexagonColor);
						colorChanged = true;
			...
			{
				btnInnerColor.setBackground(hexagonInnerColor);
				btnInnerColor.setForeground(Color.BLACK);
				btnInnerColor.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) { 
						Color temp = JColorChooser.showDialog(null, "Select a inner color", hexagonInnerColor);
						if(temp != null) {
							hexagonInnerColor = temp;
							btnInnerColor.setBackground(hexagonInnerColor);
					...
					public void actionPerformed(ActionEvent arg0) {
						if (txtCenterX.getText().isEmpty() || txtCenterY.getText().isEmpty()
							...
							if (x < 0) {
								...
								hexagon = new HexagonAdapter(new Hexagon(x, y, radius));
								if (colorChanged) {
									hexagon.setColor(hexagonColor);
									hexagon.setInnerColor(hexagonInnerColor);
								}
								dispose();
							}
						}
